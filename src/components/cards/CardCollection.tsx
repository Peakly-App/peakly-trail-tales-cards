...
const sampleCards = [
  ...
  },
  {
    ...
    description: "Rising nearly 5,000 feet above the valley floor, Half Dome is an iconic landmark in Yosemite National Park. The granite dome is a popular but challenging hiking destination."
  },
  {
    id: 3,
    name: "Mount Hood",
